...
#pragma config(Motor,  port2,           driveLeft_2,       tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port3,           driveRight_1,       tmotorVex393HighSpeed_MC29, openLoop, reversed)
...
#pragma config(Motor,  port8,           driveRight_2,       tmotorVex393HighSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port9,           driveLeft_1,       tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port10,          gol,          tmotorVex393HighSpeed_HBridge, openLoop, reversed)
